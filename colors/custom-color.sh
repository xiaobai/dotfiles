#!/bin/sh
# My Custom Colorscheme - Shell color setup script
# xiaobai (bulbazord.me)
...
color07="f9/f8/f5" # Base 05 - White
color08="75/71/5e" # Base 03 - Bright Black
color09="f9/30/26" # Base 08 - Bright Red
color10="a6/e2/2e" # Base 0B - Bright Green
color11="f9/ee/98" # Base 0A - Bright Yellow
color12="66/d9/ef" # Base 0D - Bright Blue
color13="ae/81/ff" # Base 0E - Bright Magenta
color14="a1/ef/e4" # Base 0C - Bright Cyan
